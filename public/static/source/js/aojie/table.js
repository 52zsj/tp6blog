    ...
    api: {
        bindevent: function (defaults) {
            ...
            if (options.is_tree == true) {
                layui.config({
                    base: '/static/source/plugins/layui-module/' //你存放新模块的目录，注意，不是layui的模块目录
                }).extend({
                    treetable: 'treetable-lay/treetable',
                }).use('treetable', function () {
                    var tree_table = layui.treetable;
            ...
            layui.use('table',function () {
                var table_on = layui.table;
                // table_on.on('tool(' + options.id + ')', function (obj) {
                //     var event = obj.event;
                //     var id = obj.data.id;
                //     switch (event) {
                //         case 'edit':
                ...
                // });
                //行内编辑
                table_on.on('edit(' + options.id + ')', function (obj) {
                ...
                //左侧toolbar
                table_on.on('toolbar(' + options.id + ')', function (obj) {
                    console.log(obj);
                    //获取选中
                ...
                //状态选择
                table_on.on('checkbox(' + options.id + ')', function (obj) {
                    //判断当前是全选还是单选则
